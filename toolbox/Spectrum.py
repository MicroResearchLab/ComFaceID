...
from matchms.filtering.add_retention import _add_retention
from matchms.filtering.interpret_pepmass import _interpret_pepmass_metadata
from matchms.filtering.make_charge_int import _convert_charge_to_int
...
class Spectrum:
    ...
    def __init__(self, mz: np.array,
        ...
        metadata_harmonization : bool, optional
            ...
            The default is True.
        """
        self._metadata = Metadata(metadata,False)
    ...
    def _apply_metadata_harmonization(self):
        ...
        self._metadata = Metadata(metadata_filtered,False)
